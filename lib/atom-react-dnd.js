...
export function Draggable(itemType, WrappedComponent, spec, collect) {
  return class extends React.Component {
    ...
    render() {
      const wrappedProps = Object.assign({}, this.props, collect(dragMonitor(this)));
    ...
    startDrag(e, draggable) {
      ...
      dragState.update(() => {return {dragged: this, itemType};});
    }
    
    endDrag(e) {
      dragState.update(() => {return {dragged: null, itemType: null};});
      this.ghost.remove();
    }
  };
}
...
export function DropTarget(itemTypes, WrappedComponent, spec, collect) {
  ...
  function dropTargetMonitor(component) {
    return {
      canDrop() {return itemTypes.includes(dragState.itemType);},
  ...
  return class extends React.Component {
    ...
    dragEnter(e) {
      if (this.dropAllowed(this.getDragData(e))) {
